...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ParameterSetting_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ParameterSetting_t qt_meta_stringdata_ParameterSetting = {
    {
QT_MOC_LITERAL(0, 0, 16), // "ParameterSetting"
QT_MOC_LITERAL(1, 17, 9), // "updatePar"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(4, 50, 19) // "on_scanPath_clicked"

    },
    "ParameterSetting\0updatePar\0\0"
    "on_buttonBox_accepted\0on_scanPath_clicked"
};
...
void ParameterSetting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updatePar(); break;
        case 1: _t->on_buttonBox_accepted(); break;
        case 2: _t->on_scanPath_clicked(); break;
        default: ;
        }
        ...
        {
            typedef void (ParameterSetting::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ParameterSetting::updatePar)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ParameterSetting::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ParameterSetting.data,
      qt_meta_data_ParameterSetting,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ParameterSetting::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ParameterSetting.stringdata0))
...
// SIGNAL 0
void ParameterSetting::updatePar()
{
